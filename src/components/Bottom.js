...
const Bottom = ({ img, oldprice, newprice, name,id }) => {
  ...
  return (
    <>
      <Link to={`/Product/${id}`} className='text-decoration-none'>
        ...
        <div className="row">
          <a href='#' className='mb-0  text-decoration-none text-black fw-bold fs-4' >{name}</a>
          </div>
        <div className="row w-75  fs-6  text-black ">
