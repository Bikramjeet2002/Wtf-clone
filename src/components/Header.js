...
export const Header = () => {
  ...
  return (
    ...
    <div className="banner d-lg-none " style={{position:"relative"}}>
        <video style={{height:"75vh",width:"100%",objectFit:"cover"}} autoPlay muted loop src="../img/WhatsApp Video 2024-04-16 at 12.15.24_de94e411.mp4"></video>
    ...
    <div className="banner d-lg-block d-none " style={{background:"url('./img/bannerDesk.webp')",backgroundRepeat:"no-repeat",backgroundSize:"cover",backgroundPosition:"center",height:"75vh",position:"relative"}}>
